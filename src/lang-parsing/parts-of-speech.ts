...
const adjectiveRegex = /\b(?:small|big|large|li(l|ttle)|premium|s(a|o)me)|live|white|black|brown|nice|best|worst|good|bad|fat|stupid|dumb|chubby\b/gi;
const helperVerbRegex = /\b(?:let'?s|gonna|go|will|have|can)\b/gi;
